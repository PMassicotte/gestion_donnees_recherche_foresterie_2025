...
Use a `README` file to provide an overview of the project and instructions on how to use the data and scripts. It can include:
...
- Good documentation makes your research [reproducible]{.emphasize} and [reusable]{.emphasize}.
...
- **Units**: meters, kilograms, degrees Celsius, etc.

- **Type**: numeric, categorical, date, etc.

- **Allowed values**: range or list of valid values.

:::

## Data dictionary — example

A data dictionary can be a simple `CSV` file or a table in your README.

```{r}
#| label: data-dictionary-example
#| echo: false
tibble::tribble(
  ~variable       , ~description                , ~unit , ~type         , ~allowed_values             ,
  "site_id"       , "Unique site identifier"    , NA    , "text"        , "S001, S002, ..."           ,
  "species"       , "Tree species code"         , NA    , "categorical" , "PICEA_MAR, ABIES_BAL, ..." ,
  "dbh"           , "Diameter at breast height" , "cm"  , "numeric"     , "0.1–150"                   ,
  "height"        , "Total tree height"         , "m"   , "numeric"     , "0.5–50"                    ,
  "date_measured" , "Date of measurement"       , NA    , "date"        , "YYYY-MM-DD"
) |>
  gt() |>
  cols_label(
    variable = "Variable",
...
- Add a **header block** at the top of each script:
  - Author, date, purpose.

- Comment the [**why**]{.emphasize}, not the [**what**]{.emphasize}.
...
![Source: https://bit.ly/2M8cViI](img/screenshots/python_file_naming.png){fig-alt="Screenshot of a scientific taking his head in his hands and sitting at a desk."}
...
- Polar Data Catalogue [https://www.polardata.ca/](https://www.polardata.ca/){target="\_blank"}
...
- Pangaea [https://www.pangaea.de/](https://www.pangaea.de/){target="\_blank"}
...
- Seanoe [https://www.seanoe.org/](https://www.seanoe.org/){target="\_blank"}
- NFS Arctic Data Center [https://arcticdata.io/](https://arcticdata.io/){target="\_blank"}
