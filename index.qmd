...
[Each project directory should be self-contained and include all the necessary files to reproduce the analyses and results.]{.emphasize}

You should be able to share the project directory with a colleague and they should be able to reproduce the analyses and results without having to ask you for additional information.
