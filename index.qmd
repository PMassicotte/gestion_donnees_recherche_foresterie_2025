...
- Project organization and raw data management.
...
# File naming {background-color="#2C404A"}
...
# Project organization and raw data management {background-color="#2C404A"}

::: {.center-align}

![AI generated image of a scientist looking at a computer screen with data on it.](./img/ai/working_with_other_data.png){height=500 fig-alt="AI generated image of a scientist looking at a computer screen with data on it."}
...
# Documentation and metadata {background-color="#2C404A"}

::: {.center .v-center-container}

{{< fa book size=5x >}} {{< fa file-lines size=5x >}}
