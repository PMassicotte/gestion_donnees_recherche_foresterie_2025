...
![AI generated image of a scientist looking at a computer screen with data on it.](./img/ai/working_with_other_data.png){height=600 fig-alt="AI generated image of a scientist looking at a computer screen with data on it."}
...
- Cleaned data files.
- Code scripts.
- A `README` file with an overview of the project and instructions for use:
  - Documentation and metadata.
  - If external data is used, make sure to properly cite it and provide links to the original sources.
  - Your colleagues should be able to get all the data they need to reproduce your analyses and results.
